(() => {
    ...
    let searchLabel = document.querySelectorAll(".item-search__label");
    for (let i = 0; i < searchLabel.length; i++) searchLabel[i].onclick = function() {
    ...
    class SelectConstructor {
        constructor(props, data = null) {
            ...
            this.selectClasses = {
                ...
                classSelectContent: "_icon-arrow-bottom select__content",
    ...
    function initSliders() {
        if (document.querySelector(".slider-product")) {
            const thumbsSwiper = new core(".slider-product-thumbs", {
